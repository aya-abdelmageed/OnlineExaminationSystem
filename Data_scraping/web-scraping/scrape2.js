...
(async () => {
    try {
        ...
        const url = `https://www.placementpreparation.io/mcq/object-oriented-programming/page/${p}/`;
        ...
        const outputFilePath = 'scraped_questions_oop.txt'; // Path to the output file
